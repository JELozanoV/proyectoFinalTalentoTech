...
var getAppointments = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, appointmentService_1.getAllAppointmentsService)()];
            case 1:
...
var getAppointmentById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, (0, appointmentService_1.getAppointmentByIdService)(Number(id))];
            case 2:
                appointment = _a.sent();
...
var scheduleAppointment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userId, date, time, description, newAppointment, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, userId = _a.userId, date = _a.date, time = _a.time, description = _a.description;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4, (0, appointmentService_1.createAppointmentService)({
                        userId: userId,
                        date: date,
                        time: time,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!appointmentId) {
                    return [2, res.status(400).json({ message: "ID de turno no válido" })];
                }
                return [4, (0, appointmentService_1.cancelAppointmentService)(appointmentId)];
            case 1:
                _a.sent();
