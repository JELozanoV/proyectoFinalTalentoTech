...
var credentialServide_1 = require("../services/credentialServide");
var getUsers = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, userService_1.getAllUsersService)()];
            case 1:
                users = _a.sent();
...
var registerUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, birthdate, nDni, username, password, newUser, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, (0, userService_1.createUserService)({ name: name, email: email, birthdate: birthdate, nDni: nDni, username: username, password: password })];
            case 1:
                newUser = _b.sent();
...
var loginUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, credential, user, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4, (0, credentialServide_1.validateCredential)({
                        username: username,
                        password: password
                    })];
            case 2:
                credential = _b.sent();
                return [4, (0, userService_1.findUserByCredentialId)(credential.id)];
            case 3:
                user = _b.sent();
