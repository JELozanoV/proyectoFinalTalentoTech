...
var appointmentModel = data_source_1.AppDataSource.getRepository(Appointments_1.Appointments);
...
var getAllAppointmentsService = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                allAppointment = _a.sent();
                return [2, allAppointment];
        }
    });
}); };
...
var createAppointmentService = function (createAppointmentDto) { return __awaiter(void 0, void 0, void 0, function () {
    var newAppointment, user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                newAppointment = appointmentModel.create(createAppointmentDto);
                return [4, userModel.findOneBy({
            ...
            case 3:
                error_1 = _a.sent();
                throw new Error("Error al crear el turno: " + error_1.message);
            case 4: return [2];
        }
    });
}); };
...
var cancelAppointmentService = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4, appointmentModel.findOneBy({ id: id })];
            case 1:
                appointment = _a.sent();
                if (!appointment) {
                    throw new Error("Turno no encontrado");
            ...
            case 3:
                error_2 = _a.sent();
                throw new Error("Error al cancelar el turno: " + error_2.message);
            case 4: return [2];
        }
    });
}); };
